...
contract POWHClone {
	...
	function fixedLog(uint256 a) internal  returns (int256 log) {
		int32 scale = 0;
		while (a > sqrt2) {
			a /= 2;
			scale++;
	...
	function fixedExp(int256 a) internal  returns (uint256 exp) {
...
contract SMARTEST is POWHClone {
  constructor () POWHClone () public payable {}
