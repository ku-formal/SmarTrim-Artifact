...
contract EtherWin is EtherWinAccessControl {
    ...
    function transferEthersToDividendManager() public {
        ...
        ownerWallet1.transfer(valueFromPercent(dividends,5000)); // <LEAK_VUL>
        ownerWallet2.transfer(valueFromPercent(dividends,30000)); // <LEAK_VUL>
        ownerWallet3.transfer(valueFromPercent(dividends,35000)); // <LEAK_VUL>

        DividendManagerInterface dividendManager = DividendManagerInterface(dividendManagerAddress);
        dividendManager.depositDividend.value(valueFromPercent(dividends,15000))(); // <LEAK_VUL>
