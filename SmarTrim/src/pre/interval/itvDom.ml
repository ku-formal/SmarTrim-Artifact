...
module Loc = struct
  ...
  let compare (id1,_) (id2,_) = BatString.compare id1 id2
  let of_var id t = (id,t)
  let typ_of (_,t) = t
  let to_string (id,_) = id
end
...
module Val = struct
  ...
  let update_itv a' (_,b,c) = (a',b,c) 
  let update_gtaint b' (a,_,c) = (a,b',c)
  let update_btaint c' (a,b,_) = (a,b,c')
