...
contract TokenPool_1 {
  ...
  function TokenPool_1(
    TokenPool_1List list,
    string _name,
    uint _fundingLimit,
...
contract TokenPool is TokenPool_1 {
    constructor(TokenPoolList list,    string _name,    uint _fundingLimit,    uint _rewardPercentage,    ERC20 _tokenContract,    address _tokenCreateContract,    string _tokenCreateFunction) TokenPool_1(list, _name, _fundingLimit, _rewardPercentage, _tokenContract, _tokenCreateContract, _tokenCreateFunction) public { }
}
