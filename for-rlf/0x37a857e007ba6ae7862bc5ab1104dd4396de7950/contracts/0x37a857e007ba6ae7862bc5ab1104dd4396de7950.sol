...
contract TaskRegister_1 is Upgradable, VanityLib {
    ...
    function upgrade(uint _size) public onlyOwner {
        ...
        TaskRegister_1 prev = TaskRegister_1(upgradableState.prevVersion);
...
contract TaskRegister is TaskRegister_1 {
    constructor() TaskRegister_1(address(0x123), address(0x123)) public { }
}
