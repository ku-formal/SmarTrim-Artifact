...
contract FundsRegistry_1 is ArgumentsChecker, MultiownedControlled, ReentrancyGuard {
    ...
    function FundsRegistry_1(address[] _owners, uint _signaturesRequired, address _controller)
...
contract FundsRegistry is FundsRegistry_1 {
    constructor() FundsRegistry_1(address(0x123), 78, address(0x123)) public { }
}
