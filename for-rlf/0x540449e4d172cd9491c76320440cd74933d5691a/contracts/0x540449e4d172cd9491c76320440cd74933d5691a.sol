...
contract DecentBetVault is SafeMath {
    ...
    DecentBetToken_1 decentBetToken;
    ...
    function DecentBetVault(address _decentBetMultisig)  {
        ...
        decentBetToken = DecentBetToken_1(msg.sender);
...
contract DecentBetToken_1 is SafeMath, ERC20 {

    
    bool public isDecentBetToken_1 = false;
    ...
    function DecentBetToken_1(address _decentBetMultisig,
...
contract DecentBetToken is DecentBetToken_1 {
    constructor() DecentBetToken_1(address(0x123), address(0x123), address(0x123), 78, 78, 78) public { }
}
