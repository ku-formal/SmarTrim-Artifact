...
contract MarketboardERC20Listing_1 {
    ...
    function MarketboardERC20Listing_1(address _moderator, uint256 _feeFixed, uint32 _feePercentage, address _erc20Token, uint256 _tokenPrice) public {
...
contract MarketboardERC20Listing is MarketboardERC20Listing_1 {
    constructor() MarketboardERC20Listing_1(address(0x123), 78, 78, address(0x123), 78) public { }
}
