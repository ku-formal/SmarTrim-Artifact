...
contract CertificationDb_1 is CertificationDb_1I, WithFee, PullPaymentCapable {
...
contract CertificationDb is CertificationDb_1 {
    constructor() CertificationDb_1(address(0x123), 78, address(0x123)) public { }
}
