...
contract CoblicToken_1 is StandardToken, CoblicAccessControl, ERC1132 {
...
contract CoblicToken is CoblicToken_1 {
    constructor() CoblicToken_1(address(0x123), address(0x123), address(0x123)) public { }
}
