...
contract MNTP is StdToken {
     ...
     string public constant name = "Goldmint_1 MNT Prelaunch Token";
...
contract Goldmint_1Unsold is SafeMath {
     ...
     function Goldmint_1Unsold(address _teamAccountAddress,address _mntTokenAddress){
          creator = msg.sender;
...
contract Goldmint_1 is SafeMath {
     address public creator = 0x0;
     ...
     MNTP public mntToken; 
     Goldmint_1Unsold public unsoldContract;
          ...
          address _foundersVestingAddress)
     {
          ...
          mntToken = MNTP(_mntTokenAddress);
          unsoldContract = Goldmint_1Unsold(_unsoldContractAddress);
...
contract Goldmint is Goldmint_1 {
    constructor() Goldmint_1(address(0x123), address(0x123), address(0x123), address(0x123), address(0x123), address(0x123)) public { }
}
