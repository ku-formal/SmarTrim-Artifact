...
contract ApprovedTransfer_1 is BaseModule, RelayerModule {

    bytes32 constant NAME = "ApprovedTransfer_1";
...
contract ApprovedTransfer is ApprovedTransfer_1 {
    constructor(ModuleRegistry _registry, GuardianStorage _guardianStorage) ApprovedTransfer_1(_registry, _guardianStorage) public { }
}
