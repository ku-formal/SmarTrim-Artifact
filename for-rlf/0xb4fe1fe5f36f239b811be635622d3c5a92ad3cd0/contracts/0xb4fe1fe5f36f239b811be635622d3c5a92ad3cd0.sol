...
contract Store_1Gifts is BasicAuth
{
    struct Gift
    {
        string m_Key;
...
contract Store_1Goods is BasicAuth
{
    using ItemList for ItemList.Data;
...
contract Store_1 is Child
{
    ...
    Store_1Goods g_Goods;
    Store_1Gifts g_Gifts;

    constructor(Main main, Store_1Goods goods, Store_1Gifts gifts) public Child(main)
    {
        g_Goods = goods;
        g_Gifts = gifts;
...
contract Store is Store_1 {
    constructor(Main main, StoreGoods goods, StoreGifts gifts) Store_1(main, goods, gifts) public { }
}
