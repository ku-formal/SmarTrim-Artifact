	...
	function isTheAO(address _sender, address _theAO, address _nameTAOPositionAddress) public view returns (bool) {
		return (_sender == _theAO ||
			(
				...
				INameTAOPosition_1(_nameTAOPositionAddress).senderIsAdvocate(_sender, _theAO)
			)
		);
	}
...
contract TAOCurrency is TheAO {
	...
	constructor (string memory _name, string memory _symbol, address _nameTAOPositionAddress) public {
		...
		setNameTAOPosition_1Address(_nameTAOPositionAddress);
	}
	...
	function setNameTAOPosition_1Address(address _nameTAOPositionAddress) public onlyTheAO {
...
contract Logos is TAOCurrency {
	...
	INameTAOPosition_1 internal _nameTAOPosition;
	...
	function setNameTAOPosition_1Address(address _nameTAOPositionAddress) public onlyTheAO {
		require (_nameTAOPositionAddress != address(0));
		nameTAOPositionAddress = _nameTAOPositionAddress;
		_nameTAOPosition = INameTAOPosition_1(_nameTAOPositionAddress);
	}
...
contract NameTAOPosition_1 is TheAO, INameTAOPosition_1 {
	using SafeMath for uint256;
...
contract NameTAOPosition is NameTAOPosition_1 {
    constructor() NameTAOPosition_1(address(0x123), address(0x123)) public { }
}
