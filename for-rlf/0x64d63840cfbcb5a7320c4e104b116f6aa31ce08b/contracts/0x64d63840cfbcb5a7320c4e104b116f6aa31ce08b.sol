...
contract RDOToken is StandardToken {
    ...
    function RDOToken() public {
        ...
        crowdsale=new RDOCrowdsale_1(this,msg.sender);
    ...
    function stopCrowdfunding() onlyOwner public {
        if(crowdsale!=0x0){
            RDOCrowdsale_1(crowdsale).stopCrowdsale();
            crowdsale=0x0;
        }
    }
...
contract RDOCrowdsale_1 {
    ...
    function RDOCrowdsale_1(address _tokenAddress, address _wallet) public {
...
contract RDOCrowdsale is RDOCrowdsale_1 {
    constructor() RDOCrowdsale_1(address(0x123), address(0x123)) public { }
}
