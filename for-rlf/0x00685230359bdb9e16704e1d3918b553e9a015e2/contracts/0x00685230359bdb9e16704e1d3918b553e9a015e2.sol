...
contract DigitalPrintImage is ERC721Token("DigitalPrintImage", "DPM"), UserManager, Ownable {
    ...
    modifier onlyMarketplace_1Contract() {
    ...
    function transferFromMarketplace_1(address _from, address _to, uint256 _imageId) public onlyMarketplace_1Contract {
    ...
    function addMarketplace_1Contract(address _marketplaceContract) public onlyOwner {
...
contract Marketplace_1 is Ownable {
    ...
    function buy(uint _imageId) public payable {
        ...
        digitalPrintImageContract.transferFromMarketplace_1(sellAds[_imageId].exchanger, msg.sender, _imageId);
...
contract Marketplace is Marketplace_1 {
    constructor() Marketplace_1(address(0x123)) public { }
}
