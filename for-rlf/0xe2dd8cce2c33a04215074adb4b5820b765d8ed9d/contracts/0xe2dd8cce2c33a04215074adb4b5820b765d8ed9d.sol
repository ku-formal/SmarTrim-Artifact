...
contract MultipleArbitrableTransaction_1 is IArbitrable {
...
contract MultipleArbitrableTransaction is MultipleArbitrableTransaction_1 {
    constructor(Arbitrator _arbitrator,        bytes _arbitratorExtraData,        uint _feeTimeout) MultipleArbitrableTransaction_1(_arbitrator, _arbitratorExtraData, _feeTimeout) public { }
}
