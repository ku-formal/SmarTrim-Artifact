...
contract KingOfEth_1AuctionsAbstractInterface {
...
contract KingOfEth_1BlindAuctionsReferencer is GodMode {
...
contract KingOfEth_1OpenAuctionsReferencer is GodMode {
...
contract KingOfEth_1AuctionsReferencer is
      KingOfEth_1BlindAuctionsReferencer
    , KingOfEth_1OpenAuctionsReferencer
{
...
contract KingOfEth_1AbstractInterface {
...
contract KingOfEth_1Referencer is GodMode {
    
    address public kingOfEthContract;

    
    modifier onlyKingOfEth_1Contract()
    {
    ...
    function godSetKingOfEth_1Contract(address _kingOfEthContract)
        public
        onlyGod
    {
...
contract KingOfEth_1Board is
      GodMode
    , KingOfEth_1AuctionsReferencer
    , KingOfEth_1Referencer
{
    ...
    modifier onlyKing()
    {
        require(KingOfEth_1AbstractInterface(kingOfEthContract).king() == msg.sender);
        _;
    }
    ...
    {
        require(KingOfEth_1AbstractInterface(kingOfEthContract).wayfarer() == msg.sender);
        _;
    }
...
contract KingOfEth_1BoardReferencer is GodMode {
...
contract KingOfEth_1HousesAbstractInterface {
...
contract KingOfEth_1HousesReferencer is GodMode {
...
contract KingOfEth_1HouseRealty is
      GodMode
    , KingOfEth_1HousesReferencer
    , KingOfEth_1Referencer
{
    ...
    {
        require(KingOfEth_1HousesAbstractInterface(housesContract).ownerOf(_x, _y) == msg.sender);
        _;
    }
        ...
        existingHouseSale(_x, _y)
    {
        ...
        KingOfEth_1AbstractInterface(kingOfEthContract).payTaxes.value(taxCut)();

        KingOfEth_1HousesAbstractInterface _housesContract = KingOfEth_1HousesAbstractInterface(housesContract);
...
contract KingOfEth_1HouseRealtyReferencer is GodMode {
...
contract KingOfEth_1RoadsAbstractInterface {
...
contract KingOfEth_1RoadsReferencer is GodMode {
...
contract KingOfEth_1EthExchangeReferencer is GodMode {
...
contract KingOfEth_1ResourceExchangeReferencer is GodMode {
...
contract KingOfEth_1ExchangeReferencer is
      GodMode
    , KingOfEth_1EthExchangeReferencer
    , KingOfEth_1ResourceExchangeReferencer
{
...
contract KingOfEth_1ResourcesInterfaceReferencer is GodMode {
...
contract KingOfEth_1Resource is
      ERC20Interface
    , GodMode
    , KingOfEth_1ResourcesInterfaceReferencer
{
...
contract KingOfEth_1ResourceType {
...
contract KingOfEth_1ResourcesInterface is
      GodMode
    , KingOfEth_1ExchangeReferencer
    , KingOfEth_1HousesReferencer
    , KingOfEth_1ResourceType
    , KingOfEth_1RoadsReferencer
{
        ...
        returns(uint)
    {
        ...
        result += KingOfEth_1Resource(bronzeContract).balanceOf(_player);
        result += KingOfEth_1Resource(goldContract).balanceOf(_player)    * 3;
        result += KingOfEth_1Resource(steelContract).balanceOf(_player)   * 6;
        result += KingOfEth_1Resource(oilContract).balanceOf(_player)     * 10;
        result += KingOfEth_1Resource(uraniumContract).balanceOf(_player) * 44;
        ...
        onlyHousesContract
    {
        ...
        KingOfEth_1Resource(contractFor(ResourceType.CORN)).interfaceBurnTokens(
              _player
            , 2 * _count
        );

        
        KingOfEth_1Resource(contractFor(ResourceType.ORE)).interfaceBurnTokens(
              _player
            , 2 * _count
        );

        
        KingOfEth_1Resource(contractFor(ResourceType.WOOD)).interfaceBurnTokens(
              _player
            , _count
        );
    }
        ...
        onlyHousesContract
    {
        ...
        if(0 == _currentLevel)
        {
            ...
            KingOfEth_1Resource(contractFor(ResourceType.BRONZE)).interfaceBurnTokens(
                  _player
                , 1
            );
        }
        else if(1 == _currentLevel)
        {
            ...
            KingOfEth_1Resource(contractFor(ResourceType.GOLD)).interfaceBurnTokens(
                  _player
                , 1
            );
        }
        else if(2 == _currentLevel)
        {
            ...
            KingOfEth_1Resource(contractFor(ResourceType.STEEL)).interfaceBurnTokens(
                  _player
                , 1
            );
        }
        else if(3 == _currentLevel)
        {
            ...
            KingOfEth_1Resource(contractFor(ResourceType.OIL)).interfaceBurnTokens(
                  _player
                , 1
            );
        }
        else if(4 == _currentLevel)
        {
            ...
            KingOfEth_1Resource(contractFor(ResourceType.URANIUM)).interfaceBurnTokens(
                  _player
                , 1
            );
        }
        ...
        onlyHousesContract
    {
        ...
        KingOfEth_1Resource(contractFor(resourceType(_x - 1, _y - 1))).interfaceMintTokens(
            _owner
          , _count
        );

        
        KingOfEth_1Resource(contractFor(resourceType(_x, _y - 1))).interfaceMintTokens(
            _owner
          , _count
        );

        
        KingOfEth_1Resource(contractFor(resourceType(_x, _y))).interfaceMintTokens(
            _owner
          , _count
        );

        
        KingOfEth_1Resource(contractFor(resourceType(_x - 1, _y))).interfaceMintTokens(
            _owner
          , _count
        );
    }
        ...
        onlyRoadsContract
    {
        ...
        KingOfEth_1Resource(cornContract).interfaceBurnTokens(
              _player
            , _length
        );

        
        KingOfEth_1Resource(oreContract).interfaceBurnTokens(
              _player
            , _length
        );
    }
    ...
    {
        KingOfEth_1Resource(contractFor(_type)).interfaceFreezeTokens(_owner, _tokens);
    }
    ...
    function exchangeThawTokens(ResourceType _type, address _owner, uint _tokens)
        ...
        onlyExchangeContract
    {
        KingOfEth_1Resource(contractFor(_type)).interfaceThawTokens(_owner, _tokens);
    }
    ...
    function exchangeTransfer(ResourceType _type, address _from, address _to, uint _tokens)
        ...
        onlyExchangeContract
    {
        KingOfEth_1Resource(contractFor(_type)).interfaceTransfer(_from, _to, _tokens);
    }
    ...
    function exchangeFrozenTransfer(ResourceType _type, address _from, address _to, uint _tokens)
        ...
        onlyExchangeContract
    {
        KingOfEth_1Resource(contractFor(_type)).interfaceFrozenTransfer(_from, _to, _tokens);
    }
}
...
contract KingOfEth_1Houses is
      GodMode
    , KingOfEth_1AuctionsReferencer
    , KingOfEth_1BoardReferencer
    , KingOfEth_1HouseRealtyReferencer
    , KingOfEth_1HousesAbstractInterface
    , KingOfEth_1Referencer
    , KingOfEth_1RoadsReferencer
    , KingOfEth_1ResourcesInterfaceReferencer
{
    ...
    function buildHouseInner(uint _x, uint _y) private
    {
        ...
        KingOfEth_1Board _boardContract = KingOfEth_1Board(boardContract);
        ...
        KingOfEth_1RoadsAbstractInterface _roadsContract = KingOfEth_1RoadsAbstractInterface(roadsContract);
        ...
        require(!KingOfEth_1AuctionsAbstractInterface(blindAuctionsContract).existingAuction(_x, _y));

        
        require(!KingOfEth_1AuctionsAbstractInterface(openAuctionsContract).existingAuction(_x, _y));
        ...
        KingOfEth_1ResourcesInterface(interfaceContract).distributeResources(
              msg.sender
            , _x
            , _y
            , 0 
        ...
        payable
    {
        ...
        KingOfEth_1AbstractInterface(kingOfEthContract).payTaxes.value(msg.value)();

        
        KingOfEth_1ResourcesInterface(interfaceContract).burnHouseCosts(
              _count
            , msg.sender
        );
    ...
    function sendHouse(uint _x, uint _y, address _to) public
    {
        ...
        KingOfEth_1HouseRealty(houseRealtyContract).housesCancelHouseSale(_x, _y);
    ...
    function upgradeHouse(uint _x, uint _y) public payable
    {
        ...
        KingOfEth_1ResourcesInterface(interfaceContract).burnUpgradeCosts(
              _locationInfo.level
            , msg.sender
        );
...
contract KingOfEth_1RoadRealty is
      GodMode
    , KingOfEth_1Referencer
    , KingOfEth_1RoadsReferencer
{
    ...
    {
        require(KingOfEth_1RoadsAbstractInterface(roadsContract).ownerOf(_x, _y, _direction) == msg.sender);
        _;
    }
...
contract KingOfEth_1RoadRealtyReferencer is GodMode {
...
contract KingOfEth_1Roads is
      GodMode
    , KingOfEth_1BoardReferencer
    , KingOfEth_1HousesReferencer
    , KingOfEth_1Referencer
    , KingOfEth_1ResourcesInterfaceReferencer
    , KingOfEth_1RoadRealtyReferencer
    , KingOfEth_1RoadsAbstractInterface
{
        ...
        payable
    {
        ...
        KingOfEth_1ResourcesInterface(interfaceContract).burnRoadCosts(
              _length
            , msg.sender
        );
        ...
        onlyRoadOwner(_x, _y, _direction)
    {
        ...
        KingOfEth_1RoadRealty(roadRealtyContract).roadsCancelRoadSale(
              _x
            , _y
            , _direction
        );
    ...
    , KingOfEth_1ResourcesInterfaceReferencer
{
    ...
    {
        KingOfEth_1Houses _housesContract = KingOfEth_1Houses(housesContract);
    ...
    {
        KingOfEth_1Roads _roadsContract = KingOfEth_1Roads(roadsContract);
    ...
    function claimParliamentSeat() public
    {
        ...
        if(0 == _senderData.points)
        {
            ...
            uint _points
                = KingOfEth_1ResourcesInterface(interfaceContract).lookupResourcePoints(msg.sender);
    ...
    function parliamentInquest(address _seat) public
    {
        ...
        if(0 != _seatData.points)
        {
            ...
            uint _newPoints
                = KingOfEth_1ResourcesInterface(interfaceContract).lookupResourcePoints(_seat);
...
contract KingOfEth is KingOfEth_1 {
    constructor() KingOfEth_1(address(0x123)) public { }
}
