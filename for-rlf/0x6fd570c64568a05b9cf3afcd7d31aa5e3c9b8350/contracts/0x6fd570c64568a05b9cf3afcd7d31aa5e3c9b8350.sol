...
contract TulipsSaleAuction_1 is TulipsRoles, TulipsSaleInterface {
    ...
    function TulipsSaleAuction_1(address _tulipsCoreContract, uint256 _cut) TulipsRoles() public {
        require(_cut <= 10000); 
        ownerCut = _cut;
...
contract TulipsSaleAuction is TulipsSaleAuction_1 {
    constructor() TulipsSaleAuction_1(address(0x123), 78) public { }
}
