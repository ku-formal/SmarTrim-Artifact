...
contract GuessTheNumberGame_1 {
    ...
    function collectOwnerWinnings() public  inState(State.OWNER_WIN){
        selfdestruct(owner); 
    }
...
contract GuessTheNumberGame is GuessTheNumberGame_1 {
    constructor() GuessTheNumberGame_1(78) public { }
}
