contract TheRichestMan_1 {
    ...
    function TheRichestMan_1(address _owner)
    {
        owner=_owner;
    }
...
contract TheRichestMan is TheRichestMan_1 {
    constructor() TheRichestMan_1(address(0x123)) public { }
}
