...
contract RC_1 is ICOEngineInterface, KYCBase {
    using SafeMath for uint256;
    ...
    function RC_1(address _tokenSaleContract, uint256 _oneTokenInUsdWei, uint256 _remainingTokens, uint256 _etherMinimum, uint256 _startTime , uint256 _endTime, address [] kycSigner, uint256[] _tokenThreshold, uint256[] _bonusThreshold ) public KYCBase(kycSigner) {
...
contract TokenSale is Ownable {
	...
	function claim(address _buyer, uint256 _amount) onlyRC_1 public returns(bool) {
...
contract RC is RC_1 {
    constructor() RC_1(address(0x123), 78, 78, 78, 78, 78, address(0x123), 78, 78) public { }
}
