...
contract EDUToken_1 is StandardToken {
    ...
    modifier freezeTeamAndAdvisersEDUToken_1s(address _address) {
    ...
    function transfer(address _to, uint256 _amount) freezeDuringEDUtokenSale freezeTeamAndAdvisersEDUToken_1s(msg.sender) returns (bool success) {
    ...
    function transferFrom(address _from, address _to, uint256 _amount) freezeDuringEDUtokenSale freezeTeamAndAdvisersEDUToken_1s(_from) returns (bool success) {
    ...
    function approve(address _spender, uint256 _amount) freezeDuringEDUtokenSale freezeTeamAndAdvisersEDUToken_1s(msg.sender) returns (bool success) {
...
contract EDUToken is EDUToken_1 {
    constructor() EDUToken_1(address(0x123), address(0x123), address(0x123), address(0x123), address(0x123)) public { }
}
