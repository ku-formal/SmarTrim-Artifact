...
contract EasySmartolution_1 {
    ...
    function addReferrer(address _address) public {
        ...
        EasySmartolution_1Ref refContract = new EasySmartolution_1Ref();
...
contract EasySmartolution_1Ref {
    ...
    function () external payable {
        if (msg.value > 0) {
            EasySmartolution_1(smartolution).addParticipant.value(msg.value)(msg.sender, referrer);
        } else {
            EasySmartolution_1(smartolution).processPayment(msg.sender);
        }
    }
}
...
contract EasySmartolution is EasySmartolution_1 {
    constructor() EasySmartolution_1(address(0x123)) public { }
}
