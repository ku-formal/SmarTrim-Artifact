...
contract EthGame_1 {
    ...
    constructor (address _owner1, address _owner2, address _withdrawer,
    ...
    function setOwner1(address o) external  {
        require(o != address(0));
        require(o != owner1);
        require(o != owner2);
        owner1 = o;
    ...
    function setOwner2(address o) external  {
        require(o != address(0));
        require(o != owner1);
        require(o != owner2);
        owner2 = o;
    ...
    function setWithdrawer(address o) external onlyOwner {
        require(o != address(0));
    ...
    function withdrawFunds(address beneficiary, uint withdrawAmount) public onlyWithdrawer {
    ...
    function sendFunds(address beneficiary, uint amount, uint successLogAmount, uint commit) private {
...
contract EthGame is EthGame_1 {
    constructor() EthGame_1(address(0x123), address(0x123), address(0x123), address(0x123), address(0x123), 78) public { }
}
