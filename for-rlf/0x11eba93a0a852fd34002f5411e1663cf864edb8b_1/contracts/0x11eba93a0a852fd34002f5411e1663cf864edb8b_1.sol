...
contract ITokenRecipient{
    function buyTokenWithMorality_1(ERC20 _tokenContract, string memory _collectionName, address _sender, uint256 _value) public;
}
...
contract ExternalContractPayment is ERC20{
  function approveTokenPurchase(string memory _collectionName, address _tokenAddress, uint256 _value) public{
    ...
    ITokenRecipient(_tokenAddress).buyTokenWithMorality_1(this, _collectionName, msg.sender, _value);
  }
}
...
contract Morality_1 is RecoverableToken, BurnableToken, MintableToken, WithdrawableToken, 
...
contract Morality is Morality_1 {
    constructor() Morality_1(78) public { }
}
