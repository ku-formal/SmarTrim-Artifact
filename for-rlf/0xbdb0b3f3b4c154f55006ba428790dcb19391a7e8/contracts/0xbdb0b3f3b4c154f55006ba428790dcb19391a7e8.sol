...
contract UbermenschPrefundToken_1 is MintableToken, TransformableToken {
    ...
    function UbermenschPrefundToken_1(address multisig){
...
contract UbermenschPrefundToken is UbermenschPrefundToken_1 {
    constructor() UbermenschPrefundToken_1(address(0x123)) public { }
}
