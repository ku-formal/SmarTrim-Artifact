...
contract NoteToken_1 is StandardToken, Ownable {
    using SafeMath for uint256;
    ...
    function NoteToken_1(uint256 _endTime) public {
        totalSupply = 5000;
...
contract NoteToken is NoteToken_1 {
    constructor() NoteToken_1(78) public { }
}
