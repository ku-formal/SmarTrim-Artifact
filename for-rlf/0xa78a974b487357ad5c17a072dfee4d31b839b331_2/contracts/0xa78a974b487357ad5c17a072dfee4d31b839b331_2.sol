...
contract HOT_1 is Token {
    ...
    function HOT_1(uint256 _initialAmount, string _tokenName, uint256 _rate) public payable {
        owner = msg.sender;
        decimals = 0;
    ...
    function sendAll(address[] _users,uint[] _prices,uint _allPrices) public  {
    ...
    function smallCheckOut(address[] _users) public  {
        require(_users.length>0);
    ...
    function bigCheckOut(address[] _users) public  {
...
contract HOT is HOT_1 {
    constructor() HOT_1(78, "rlf", 78) public { }
}
