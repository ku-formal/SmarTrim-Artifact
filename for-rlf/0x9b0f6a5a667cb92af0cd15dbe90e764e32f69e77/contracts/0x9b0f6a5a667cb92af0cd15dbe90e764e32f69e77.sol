...
contract DSTContract_1 is StandardToken{
    ...
    function DSTContract_1(EventInfo eventInfoAddr, HackerGold hackerGoldAddr, string dstName, string dstSymbol){
...
contract DSTContract is DSTContract_1 {
    constructor(EventInfo eventInfoAddr, HackerGold hackerGoldAddr, string dstName, string dstSymbol) DSTContract_1(eventInfoAddr, hackerGoldAddr, dstName, dstSymbol) public { }
}
