...
contract BtcexCrowdsale_1 is FinalizableCrowdsale, Pausable {
...
contract BtcexCrowdsale is BtcexCrowdsale_1 {
    constructor(TokenStrategy _tokenStrategy,        BtcexToken _token,        uint _tokenPrice,        uint _startPreSale,        uint _endSale,        address _ownerWallet,        address _teamWallet,        address _advisorWallet) BtcexCrowdsale_1(_tokenStrategy, _token, _tokenPrice, _startPreSale, _endSale, _ownerWallet, _teamWallet, _advisorWallet) public { }
}
