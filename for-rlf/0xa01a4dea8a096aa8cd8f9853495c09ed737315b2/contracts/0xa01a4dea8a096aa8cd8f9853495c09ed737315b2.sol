...
contract RailzTokenSale_1 is Owned {
	...
	function RailzTokenSale_1(RailzToken _addressOfRewardToken, address _wallet) public {        
...
contract RailzTokenSale is RailzTokenSale_1 {
    constructor(RailzToken _addressOfRewardToken, address _wallet) RailzTokenSale_1(_addressOfRewardToken, _wallet) public { }
}
