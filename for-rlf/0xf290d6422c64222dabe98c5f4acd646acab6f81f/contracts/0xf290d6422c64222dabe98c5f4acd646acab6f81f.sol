...
contract ENSNFT_1 is ERC721Token, Ownable {
...
contract ENSNFT is ENSNFT_1 {
    constructor(string _name, string _symbol, Registrar _registrar, Metadata _metadata) ENSNFT_1(_name, _symbol, _registrar, _metadata) public { }
}
