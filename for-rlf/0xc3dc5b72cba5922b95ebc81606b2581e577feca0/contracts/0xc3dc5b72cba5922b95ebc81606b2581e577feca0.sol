...
contract TokedoExchange_1 is Ownable, Adminable {
...
contract TokedoExchange is TokedoExchange_1 {
    constructor() TokedoExchange_1(address(0x123), address(0x123), 78) public { }
}
