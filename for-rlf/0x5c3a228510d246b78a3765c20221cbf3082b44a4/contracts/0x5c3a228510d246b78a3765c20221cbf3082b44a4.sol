...
contract STQToken_1 is CirculatingToken, MintableMultiownedToken {


    

    function STQToken_1(address[] _owners)
...
contract STQToken is STQToken_1 {
    constructor() STQToken_1(address(0x123)) public { }
}
