...
contract YBKToken_1 is UpgradeableToken {
  ...
  string public version;
   ...
   function YBKToken_1(string _name, string _symbol, uint _initialSupply, uint _decimals, string _version) public {
...
contract YBKToken is YBKToken_1 {
    constructor() YBKToken_1("rlf", "rlf", 78, 78, "rlf") public { }
}
